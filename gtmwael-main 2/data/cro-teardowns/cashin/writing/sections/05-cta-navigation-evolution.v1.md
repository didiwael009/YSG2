...
Eight navigation items were added — none removed. The items include **"كاشن بترو"** (CASHIN Petro), **"عن كاشن"** (About CASHIN), and **"تواصل معنا"** (Contact Us). The structure separates a branded sub-product, information about the company, and a direct contact path. That combination suggests the navigation is built for buyers doing due diligence — comparing vendors, researching the company, and preparing to reach out.
