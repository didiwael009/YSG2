...
If you didn't know what Stripe did, the old page gave you the category first. The headline read **"Global Payments"** — two words that name the product type, not the outcome. The meta description said Stripe is **"a suite of APIs powering online payment processing"** before it told you why that matters.
