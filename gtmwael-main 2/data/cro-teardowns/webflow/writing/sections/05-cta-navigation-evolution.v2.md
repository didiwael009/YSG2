...
Webflow's CTA stack grew from one entry point to several, each pointing toward a different type of buyer. The original **"Get started — it's free"** assumed cost was the barrier worth removing first. The new stack includes **"Contact Sales"** and **"Talk to sales"** alongside **"Start for free"** — which suggests the page may now expect some visitors who have already cleared the affordability question.
