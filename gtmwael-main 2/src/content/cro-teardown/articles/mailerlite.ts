...
export const mailerlite: CroTeardownPost = {
  ...
  title: "MailerLite Teardown: From Email Tool to 5-Product Suite",
  h1: "MailerLite Homepage Teardown: From Single Email Tool to 5-Product Suite",
  metaTitle: "MailerLite Teardown: From Email Tool to 5-Product Suite",
  description: "MailerLite grew from a single email tool to a five-product suite, using 'Keeping it Lite' as an anti-complexity promise against Mailchimp.",
