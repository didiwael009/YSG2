...
export const mailerlite: CroTeardownPost = {
  ...
  title: "MailerLite Teardown: From Single Email Tool to 5-Product Suite",
  h1: "MailerLite Homepage Teardown: From Single Email Tool to 5-Product Suite",
  metaTitle: "MailerLite Teardown: From Single Email Tool to 5-Product Suite",
  description: "MailerLite expanded from a single email newsletter tool to a five-product suite while using 'Keeping it Lite' as an explicit anti-complexity promise against Mailchimp and ActiveCampaign.",
