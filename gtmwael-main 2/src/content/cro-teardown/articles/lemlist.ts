 ...
 *
 * Published    : 2026-06-10T22:48:58.566Z
 * Final judge  : 92/100 ✓
 * SEO score    : 84/100 ✓
 *
 * Source files used:
 *   data/cro-teardowns/lemlist/writing/generated-article-data.json
 *   data/cro-teardowns/lemlist/writing/article-final.md
 *   data/cro-teardowns/lemlist/writing/seo.json
 *
 * To regenerate article content:
 *   npm run cro-teardown:compose -- --slug lemlist --mode standard --force
 *   npm run cro-teardown:publish -- --slug lemlist
 */

import type { CroTeardownPost } from "../types";

export const lemlist: CroTeardownPost = {
  slug: "lemlist",
  companyName: "lemlist",
  companyUrl: "https://www.lemlist.com",
  category: "CRO Teardown",
  title: "lemlist Homepage Teardown: Jul 2019 to Jun 2026",
  h1: "How lemlist rewrote its homepage over 7 years",
  metaTitle: "lemlist Homepage Teardown: Jul 2019 to Jun 2026",
  description: "A CRO teardown of lemlist's homepage from Jul 2019 to Jun 2026 — what changed in headline, section headings, CTAs, navigation, and what SaaS teams can study from it.",
  excerpt: "lemlist's homepage didn't just get updated. The headline, section headings, CTAs, navigation all shifted in a consistent direction between Jul 2019 and Jun 2026. This teardown maps what changed, when, and what the patterns may suggest.",
  ...
  readTime: "9 min read",
  featuredImage: "/cro-teardowns/lemlist/selected/2019-07.webp",
  featuredImageAlt: "lemlist homepage — Jul 2019",
  fromLabel: "Jul 2019",
  toLabel: "Jun 2026",
  snapshots: [
    {
      month: "2019-07",
      label: "Jul 2019",
      screenshotPath: "/cro-teardowns/lemlist/selected/2019-07.webp",
    },
    {
      month: "2021-01",
      label: "Jan 2021",
      screenshotPath: "/cro-teardowns/lemlist/selected/2021-01.webp",
    },
    {
      month: "2023-01",
      label: "Jan 2023",
      screenshotPath: "/cro-teardowns/lemlist/selected/2023-01.webp",
    },
    {
      month: "2023-07",
      label: "Jul 2023",
    ...
    },
    {
      month: "current",
      label: "Today",
      screenshotPath: "/cro-teardowns/lemlist/selected/current-live.webp",
    },
  ],
  summaryCards: [
    {
      label: "Period covered",
      value: "Jul 2019 → Jun 2026",
  ...
  messagingChanges: [
    {
      ...
      before: "Send cold emails that get replies",
      after: "The AI Outbound Platform for Relevant Outreach at Every Scale",
    ...
    {
      element: "Page title",
      before: "lemlist • Send cold emails that get replies",
      after: "lemlist | The AI Outbound Platform for Relevant Outreach at Every Scale",
    },
  ],
  h2Added: [
