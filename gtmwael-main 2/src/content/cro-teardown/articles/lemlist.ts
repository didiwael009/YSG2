...
export const lemlist: CroTeardownPost = {
  ...
  featuredImageAlt: "lemlist homepage Jul 2019 — 'Send cold emails that get replies' hero with single cold email tool positioning",
  fromLabel: "Jul 2019",
  toLabel: "Jun 2026",
  snapshots: [
    {
