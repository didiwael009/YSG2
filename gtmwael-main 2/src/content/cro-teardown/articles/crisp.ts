...
export const crisp: CroTeardownPost = {
  ...
  title: "Crisp Teardown: From 'Human Touch' Startup Tool to AI-First Platform",
  h1: "Crisp Homepage Teardown: From 'Human Touch' Differentiator to AI-First Platform",
  metaTitle: "Crisp Teardown: From 'Human Touch' Startup Tool to AI-First Platform",
  description: "Crisp moved from emotional 'human touch' messaging for SMBs to AI capability demonstration for broader audiences — replacing trial exploration with immediate AI agent deployment.",
