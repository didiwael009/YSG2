...
export const stripe: CroTeardownPost = {
  ...
  title: "Stripe Teardown: From Payment API to Enterprise Revenue",
  h1: "Stripe Homepage Teardown: From Developer API to Enterprise Infrastructure",
  metaTitle: "Stripe Teardown: From Payment API to Enterprise Revenue",
  description: "Stripe moved from developer API positioning to a revenue-growth outcome promise — replacing product navigation with enterprise audience segmentation.",
