...
export const stripe: CroTeardownPost = {
  ...
  title: "Stripe Teardown: From Developer Payment API to Enterprise Infrastructure",
  h1: "Stripe Homepage Teardown: From Developer API to Enterprise Infrastructure",
  metaTitle: "Stripe Teardown: From Developer Payment API to Enterprise Infrastructure",
  description: "Stripe moved from 'Global Payments' developer API positioning to a revenue-growth outcome promise — replacing product-specific navigation with audience segmentation paths for enterprise buyers.",
  ...
  featuredImageAlt: "Stripe homepage Oct 2022 — 'Global Payments' developer-centric API positioning with product-navigation menu",
  fromLabel: "Oct 2022",
  toLabel: "Jun 2026",
  snapshots: [
    {
