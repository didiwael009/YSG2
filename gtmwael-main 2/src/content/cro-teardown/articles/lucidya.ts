...
export const lucidyaV2: CroTeardownPost = {
  ...
  title: "Lucidya Teardown: Category Climb That Buried Its Moat",
  h1: "Lucidya climbed the category ladder — and buried its moat",
  metaTitle: "Lucidya Teardown: Category Climb That Buried Its Moat",
  description: "How Lucidya's climb from 'Arabic social listening tool' to 'CX intelligence platform' expanded its market but buried its defensible wedge.",
