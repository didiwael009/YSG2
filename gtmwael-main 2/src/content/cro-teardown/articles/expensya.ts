...
export const expensya: CroTeardownPost = {
  ...
  title: "Expensya Teardown: From Global Automation to French-Market Sales Motion",
  h1: "Expensya Homepage Teardown: From Global Automation to French-Market Demo",
  metaTitle: "Expensya Teardown: From Global Automation to French-Market Sales Motion",
  description: "Expensya replaced English-language automation positioning with French-language compliance messaging — swapping 'Free trial' for 'Réservez une démo' and narrowing from global acquisition to regional high-intent demand.",
