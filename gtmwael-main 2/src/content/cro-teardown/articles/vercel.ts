...
export const vercel: CroTeardownPost = {
  ...
  title: "Vercel Teardown: From Developer Workflow Tool to AI Cloud Platform",
  h1: "Vercel Homepage Teardown: From 'Develop. Preview. Ship.' to AI Cloud",
  metaTitle: "Vercel Teardown: From Developer Workflow Tool to AI Cloud Platform",
  description: "Vercel replaced 'Develop. Preview. Ship.' with 'Build and deploy on the AI Cloud' — shifting from a developer workflow promise to a platform category claim and rebuilding navigation for a broader buyer.",
