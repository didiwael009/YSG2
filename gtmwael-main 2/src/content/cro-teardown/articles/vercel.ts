...
export const vercel: CroTeardownPost = {
  ...
  title: "Vercel Teardown: From Dev Workflow to AI Cloud Platform",
  h1: "Vercel Homepage Teardown: From 'Develop. Preview. Ship.' to AI Cloud",
  metaTitle: "Vercel Teardown: From Dev Workflow to AI Cloud Platform",
  description: "Vercel replaced 'Develop. Preview. Ship.' with 'Build and deploy on the AI Cloud' — shifting from a developer workflow platform to AI infrastructure.",
  ...
  featuredImageAlt: "Vercel homepage Jul 2021 — 'Develop. Preview. Ship.' workflow-promise hero aimed at frontend developers",
  fromLabel: "Jul 2021",
  toLabel: "Jun 2026",
  snapshots: [
    {
