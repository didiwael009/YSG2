...
export const sendx: CroTeardownPost = {
  ...
  h1: "How SendX rewrote its homepage over 7 years",
  metaTitle: "SendX Homepage Teardown: Jan 2019 to Jun 2026",
  description: "A CRO teardown of SendX's homepage from Jan 2019 to Jun 2026 — what changed in headline, section headings, CTAs, navigation, and what SaaS teams can study from it.",
