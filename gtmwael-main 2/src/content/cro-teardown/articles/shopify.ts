...
export const shopify: CroTeardownPost = {
  ...
  title: "Shopify Teardown: From Startup Enablement to AI Commerce",
  h1: "Shopify Homepage Teardown: From Startup Enablement to AI Commerce Platform",
  metaTitle: "Shopify Teardown: From Startup Enablement to AI Commerce",
  description: "Shopify dropped beginner messaging in favour of AI tooling (Sidekick) and commerce OS positioning — reframing from startup enablement to enterprise scale.",
  ...
  featuredImageAlt: "Shopify homepage Jul 2021 — entrepreneur enablement hero with business-starter messaging and 'Start your business' CTA",
  fromLabel: "Jul 2021",
  toLabel: "Jun 2026",
  snapshots: [
    {
