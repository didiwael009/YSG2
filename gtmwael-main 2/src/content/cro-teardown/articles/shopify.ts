...
export const shopify: CroTeardownPost = {
  ...
  title: "Shopify Teardown: From Startup Enablement to AI Commerce Platform",
  h1: "Shopify Homepage Teardown: From Startup Enablement to AI Commerce Platform",
  metaTitle: "Shopify Teardown: From Startup Enablement to AI Commerce Platform",
  description: "Shopify dropped all beginner messaging — business name generators, stock photography — in favour of AI tooling (Sidekick) and outcome-oriented brand language for ambitious builders.",
