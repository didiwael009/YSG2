...
export const buffer: CroTeardownPost = {
  ...
  title: "Buffer Teardown: From Scheduling Tool to Social Workspace",
  h1: "Buffer Homepage Teardown: From Scheduling Utility to Social Workspace",
  metaTitle: "Buffer Teardown: From Scheduling Tool to Social Workspace",
  description: "Buffer retired scheduling-tool messaging in favour of a brand-as-headline identity anchored by a five-product social workspace.",
