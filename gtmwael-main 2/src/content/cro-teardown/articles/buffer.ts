...
export const buffer: CroTeardownPost = {
  ...
  title: "Buffer Teardown: From Scheduling Utility to Social Workspace Brand",
  h1: "Buffer Homepage Teardown: From Scheduling Utility to Social Workspace",
  metaTitle: "Buffer Teardown: From Scheduling Utility to Social Workspace Brand",
  description: "Buffer retired explicit pricing and outcome-focused scheduling tool messaging in favour of a brand-name-as-headline identity anchored by a five-product workspace: Publish, Create, Analyze, Collaborate.",
