...
export const brevo: CroTeardownPost = {
  ...
  title: "Brevo Teardown: From Rebrand Explanation to CLV Infrastructure",
  h1: "Brevo Homepage Teardown: From Rebrand Explanation to CLV Infrastructure",
  metaTitle: "Brevo Teardown: From Rebrand Explanation to CLV Infrastructure",
  description: "Brevo spent a year explaining its rebrand, then rewrote its homepage around customer lifetime value — replacing 'Connections that spark growth' with a multichannel repeat-revenue promise.",
