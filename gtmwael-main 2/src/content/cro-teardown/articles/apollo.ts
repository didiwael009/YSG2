...
export const apollo: CroTeardownPost = {
  ...
  title: "Apollo Teardown: From Revenue Acceleration to AI Sales",
  h1: "Apollo Homepage Teardown: From Revenue Acceleration to AI Sales Platform",
  metaTitle: "Apollo Teardown: From Revenue Acceleration to AI Sales",
  description: "Apollo.io replaced 'No one ever drowned in revenue' with AI category framing — restructuring from a prospecting tool to an end-to-end AI sales platform.",
  ...
  featuredImageAlt: "Apollo homepage Jan 2019 — 'No one ever drowned in revenue' creative H1 with revenue acceleration platform positioning",
  fromLabel: "Jan 2019",
  toLabel: "Jun 2026",
  snapshots: [
    {
