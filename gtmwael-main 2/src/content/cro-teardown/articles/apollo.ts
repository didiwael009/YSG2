...
export const apollo: CroTeardownPost = {
  ...
  title: "Apollo Teardown: From Revenue Acceleration to AI Sales Platform",
  h1: "Apollo Homepage Teardown: From Revenue Acceleration to AI Sales Platform",
  metaTitle: "Apollo Teardown: From Revenue Acceleration to AI Sales Platform",
  description: "Apollo.io replaced its 2019 H1 'No one ever drowned in revenue' with explicit AI category framing — and restructured navigation from feature breadth to distinct buyer-journey entry points.",
