...
export const intercom: CroTeardownPost = {
  ...
  title: "Intercom Teardown: From Multi-Product to AI Helpdesk",
  h1: "Intercom Homepage Teardown: From Multi-Product Platform to AI Helpdesk",
  metaTitle: "Intercom Teardown: From Multi-Product to AI Helpdesk",
  description: "Intercom replaced 'Support customers at the right moment' with 'The only helpdesk designed for the AI Agent era' — a pivot to AI-first customer service.",
