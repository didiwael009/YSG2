 ...
 *
 * Published    : 2026-06-10T19:31:34.946Z
 * Final judge  : 94/100 ✓
 * SEO score    : 85/100 ✓
 *
 * Source files used:
...
export const intercom: CroTeardownPost = {
  ...
  title: "Intercom Homepage Teardown: How It Changed Between 2023 and 2026",
  h1: "How Intercom rewrote its homepage over 3 years",
  metaTitle: "Intercom Homepage Teardown: 2023 to 2026",
  description: "How Intercom's homepage shifted from outcome-focused to AI category claim in 3 years — every headline, CTA, and navigation change analyzed.",
