...
export const clay: CroTeardownPost = {
  ...
  title: "Clay Homepage Teardown: CRO Analysis & Screenshots 2021–2026",
  h1: "Clay Homepage Teardown: From Viral 'Spreadsheet' Tool to Enterprise GTM",
  metaTitle: "Clay Homepage Teardown: CRO Analysis & Screenshots 2021–2026",
  description: "Clay homepage CRO teardown with screenshots from 2021 to 2026 — how it shifted from viral spreadsheet tool to enterprise GTM platform messaging.",
  ...
  featuredImageAlt: "Clay homepage Jul 2021 — 'The spreadsheet that fills itself' viral product-mechanism hero with self-serve trial CTA",
  fromLabel: "Jul 2021",
  toLabel: "Jun 2026",
  snapshots: [
    {
