...
export const linear: CroTeardownPost = {
  ...
  title: "Linear Teardown: From Dev Speed Tool to AI-Native Product Platform",
  h1: "Linear Homepage Teardown: From Dev Tool to AI-Native Product Platform",
  metaTitle: "Linear Teardown: From Dev Speed Tool to AI-Native Product Platform",
  description: "Linear replaced 'The issue tracking tool you'll enjoy using' with 'The product development system for teams and agents' — shifting from practitioner UX to executive AI workflow outcomes.",
