...
export const linear: CroTeardownPost = {
  ...
  title: "Linear Homepage Teardown: Screenshots 2020–2026",
  h1: "Linear Homepage Teardown: From Dev Tool to AI-Native Product Platform",
  metaTitle: "Linear Homepage Teardown: Screenshots 2020–2026",
  description: "Linear homepage screenshots from 2020 to 2026 — how it shifted from 'The issue tracking tool you'll enjoy using' to an AI-native product platform.",
  ...
  featuredImageAlt: "Linear homepage Jan 2020 — 'The issue tracking tool you'll enjoy using' hero with speed-focused developer messaging",
  fromLabel: "Jan 2020",
  toLabel: "Jun 2026",
  snapshots: [
    {
  ...
  businessContext: "## The business context behind Linear's redesign\n\nLinear entered the project management and issue-tracking market competing against established tools like Jira and GitHub Issues. In 2020, that category rewarded challengers who offered a faster, more elegant experience — the competitive logic was tool-level differentiation. Linear's early positioning as **\"The issue tracking tool you'll enjoy using\"** reflects a market where UX quality alone could win enterprise developers.\n\nThe product's evolution suggests a deliberate category exit. Replacing **\"issue tracking tool\"** with **\"product development system for teams and agents\"** points to repositioning away from head-to-head UX comparisons. Section headings shifting from **\"Built to be lightning fast\"** to **\"Make product operations self-driving\"** and **\"Review PRs and agent output\"** is consistent with targeting buyers who already assume AI agents participate in their development workflow.\n\nThis maps to a broader SaaS pattern: incumbents own functional categories, so challengers claim emergent ones before competitors arrive. Linear's move is consistent with the AI-native platform grab happening across productivity software in 2025–2026. For SaaS teams building in this space, the practical implication is that waiting for AI workflows to mature before repositioning may mean ceding category language to whoever moves first. Moving first still means the claim has to convert, and a [SaaS landing page](/landing-page-for-saas) is the cheapest place to find out whether it does.",
  quickAnswer: "Linear replaced its 2020 headline **\"The issue tracking tool you'll enjoy using\"** with **\"The product development system for teams and agents\"** — shifting from a better version of a known tool to a new category built for AI-augmented workflows. This positioning assumes visitors already believe AI agents will participate in product development and are searching for systems to manage that workflow. If your buyers are still evaluating you as a faster alternative to Jira or Asana and have not yet adopted AI agents in production, this framing may create a category mismatch.",
