...
export const linear: CroTeardownPost = {
  ...
  title: "Linear Teardown: From Dev Speed Tool to AI Platform",
  h1: "Linear Homepage Teardown: From Dev Tool to AI-Native Product Platform",
  metaTitle: "Linear Teardown: From Dev Speed Tool to AI Platform",
  description: "Linear replaced 'The issue tracking tool you'll enjoy using' with 'The product development system for teams and agents' — an AI-native platform shift.",
