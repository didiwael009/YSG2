...
export const webflow: CroTeardownPost = {
  ...
  title: "Webflow Teardown: From Code Tool to Agentic Marketing",
  h1: "Webflow Homepage Teardown: From 'Break the Code Barrier' to Growth Engine",
  metaTitle: "Webflow Teardown: From Code Tool to Agentic Marketing",
  description: "Webflow replaced 'Break the code barrier' with 'Make your website a growth engine' — shifting from a tool for builders to a marketer-led growth platform.",
