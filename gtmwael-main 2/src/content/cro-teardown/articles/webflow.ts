...
export const webflow: CroTeardownPost = {
  ...
  title: "Webflow Teardown: From Code Democratization to Agentic Marketing Platform",
  h1: "Webflow Homepage Teardown: From 'Break the Code Barrier' to Growth Engine",
  metaTitle: "Webflow Teardown: From Code Democratization to Agentic Marketing Platform",
  description: "Webflow replaced 'Break the code barrier' with 'Make your website a growth engine' — shifting from a tool for builders to AI-powered infrastructure for marketing-led growth teams.",
