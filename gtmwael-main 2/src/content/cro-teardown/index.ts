...
export const croTeardownPosts: CroTeardownPost[] = [sendx, brevo, mailerlite, crowdanalyzer, lucidyaV2, foreplay, unbounce, buffer, apify, agorapulse, webflow, gong, expensya, linear, lemlist, apollo, vercel, shopify, crisp, clay, intercom, stripe, hootsuite];
